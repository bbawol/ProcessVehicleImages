...
namespace ProcessVehicleImages
{
    class Program
    {
        ...
        private static void ProcessLicensePlate(byte[] imageByteArray)
        {
            ...
            var secretKey = "sk_5310af6fd41c54a70c9b3ee4";  // string | The secret key used to authenticate your account.  You can view your  secret key by visiting  https://cloud.openalpr.com/ 
